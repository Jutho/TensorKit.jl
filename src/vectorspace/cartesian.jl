...
# Cartesian:
#------------
immutable CartesianSpace <: ElementarySpace
    d::Int
...
# Show methods
Base.show(io::IO, V::CartesianSpace) = print(io, "CartesianSpace($(V.d))")
Base.showcompact(io::IO, V::CartesianSpace) = print(io, "R($(V.d))")
