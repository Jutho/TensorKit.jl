...
@timedtestset "Tensors with symmetry: $Istr" verbose = true begin
    ...
    # no tensor array conversion tests
    ...
    # no permutations test via conversion
    ...
    # no tensor contraction test via contraction
    ...
    # no multiplication and inverse test via conversion
    ...
    # no tensor product test via conversion
