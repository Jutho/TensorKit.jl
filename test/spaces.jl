...
@testset "$(TensorKit.type_repr(Vect[I]))" for I in sectorlist
...
@testset "ProductSpace{SU₂Space}" begin
...
@testset "Deligne tensor product of spaces" begin
